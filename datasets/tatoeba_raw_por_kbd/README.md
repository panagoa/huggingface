...
task_categories:
- translation
pretty_name: Portuguese-to-Kabardian Tatoeba Raw Machine Translations Dataset
size_categories:
- 1M<n<10M
tags:
- translation
...
dataset_info:
  ...
  - name: train
    num_bytes: 352150076
    num_examples: 2283894
  download_size: 154936035
  dataset_size: 352150076
configs:
- config_name: default
  data_files:
  - split: train
...
The source data comes from the [Tatoeba Project](https://tatoeba.org/), which is a collection of sentences and translations in many languages. The Portuguese sentences were used as source text for machine translation into Kabardian.
